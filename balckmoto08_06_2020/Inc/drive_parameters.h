...
#define MAX_APPLICATION_SPEED_RPM       4086 /*!< rpm, mechanical */
...
#define PID_TORQUE_KI_DEFAULT         3500
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           3063
#define PID_FLUX_KI_DEFAULT           3500
...
#define PID_SPEED_KP_DEFAULT          2638/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          77/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
